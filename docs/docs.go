...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "email": "support@synergyconnect.com"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.Enable2FARequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.Initiate2FAResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RegenerateCodesRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/application.Stats"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/boards/{boardId}/stickers": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Данные стикера",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateStickerRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/chat/read": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Данные для отметки",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.RecentChatsResponse"
                        }
                    }
                }
            }
        ...
        "/reminders/{id}/snooze": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Данные для откладывания",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SnoozeReminderRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateStickerRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateStickerPositionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.ProjectDetailResponse": {
            ...
            "properties": {
                "applications": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ProjectApplicationResponse"
                    }
                },
                "can_manage": {
                    "type": "boolean"
        ...
        "dto.RecentChatsResponse": {
            "type": "object",
            "properties": {
                "chats": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.RecentChatResponse"
                    }
                }
            }
        },
        ...
        "dto.SnoozeReminderRequest": {
            ...
            "properties": {
                "minutes": {
                    "description": "от 1 минуты до 24 часов",
                    "type": "integer",
                    "maximum": 1440,
                    "minimum": 1
                }
        ...
        "dto.UpdateStickerPositionRequest": {
            "type": "object",
            "required": [
                "position_x",
                "position_y"
